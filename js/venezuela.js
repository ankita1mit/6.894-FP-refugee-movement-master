...
d3.csv("assets/csv/venezuela-data.csv", function (error, data) {
    var cerealMap = {};
    ...
    makeVis_vene(cerealMap);
});

var makeVis_vene = function (cerealMap) {
    ...
    // Create canvas
    var canvas = d3.select("#vis-container-vene")
        .append("svg")
    ...
    var dropdown = d3.select("#vis-container-vene")
        .insert("select", "svg")
